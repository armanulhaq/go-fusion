...
const ViewTrip = () => {
    ...
    return (
        <div className="py-10 lg:p-10 mt-12">
            <h1 className="text-xl lg:text-3xl px-5 lg:px-10 mt-15 md:px-20 font-bold">
                Your Trip Plan
            </h1>
            {/* <pre className="mt-5 bg-gray-100 p-5 rounded">
                {JSON.stringify(tripData, null, 2)}
            </pre> */}
            <div className="p-5 lg:p-10 md:px-20 lg:pd-44 xl:pd-56">
                {/* Information Section */}
